<template>
  <div v-if="threatDetail.friendlyTranslations">
    <div class="grid grid-cols-2 mx-5 space-x-8 p-5">
        ...
        <div class="flex">
          <div class="w-2/5">
            <Input
              ...
              v-model="
                threatDetail.friendlyTranslations[selectedLanguage + '.title']
                  .value
              "
            />
          </div>
      ...
      <div class="basis-1/2">
        ...
        <Switch
          ...
          v-model="threatDetail.is_always_important"
        />
        <Switch
          :alternate="true"
          name="Mark as important if industry is:"
          v-model="threatDetail.important_if_industry_id"
        />
        ...
        />
        <Slider
          v-model="threatDetail.important_company_size"
          :max="500"
          :min="0"
          :step="1"
        />
    ...
    <div>
      <h class="text-medium font-semibold text-blue-blue mx-5"
        >Display Options</h
      >
    </div>
    <div class="grid grid-cols-2 mx-5 space-x-8 p-5">
      <div>
        <div>
          <Switch
            name="Active"
            v-model="threatDetail.is_display_active_always"
          />
        </div>
        <div class="mt-2">
          <Switch
            ...
            v-model="threatDetail.show_if_industry"
          />
        </div>
        <div class="mt-3">
          <Vselect
